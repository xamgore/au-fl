...
Func : fun id '(' Args ')' Block
          { Func $2 (reverse $4) $6 }
     | fun id '(' Args ')' '=>' Expr ';'
          { Func $2 (reverse $4) [CallSt (TId "return" 0 0 0) [$7]] }
...
Stmt : Bindings Expr ';'         { reverse $ assign $1 $2 }
     | id '(' VArgs ')' ';'      { [CallSt $1 (reverse $3)] }
     | if Expr Block else Block  { [If $2 $3 $5] }
     | while Expr do Block       { [While $2 $4] }
     | for id in '[' Expr ',' Expr ']' do Block
        { [ While (Binary (TLE 0 0 0) (Const $2) (Const $ endRange $2)) $10,
            Assign (endRange $2) $5, Assign $2 $5 ] }
     -- | Block                     { Block $1 }
